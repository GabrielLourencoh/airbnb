...
# Carregue seu modelo se já estiver salvo
...
if botao:
    ...
    # Supondo que "Dados.csv" contenha as colunas que o modelo espera
    dados = pd.read_csv("Dados.csv")
    colunas = list(dados.columns)[1:-1]
    valores_x = valores_x[colunas]
    
    # Carrega o modelo salvo e realiza a previsão
    modelo = joblib.load('modelo.joblib')
